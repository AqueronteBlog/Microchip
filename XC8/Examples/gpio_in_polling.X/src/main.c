/**
 * @brief       main.c
 * @details     This programs shows how to work with the internal peripheral: GPIO as an input.
 *              All LEDs change their states every time the switch S2 is pressed.
 *
 *
 * @return      N/A
 *
...
void main(void) {
    ...
    while ( 1U )
    {
        ...
        if ( ( PORTA & S2_MSK ) == 0U )
        {
            ...
            LATB    ^=  ( D2 | D3 | D4 | D5 ); // Change the LEDs states
        }
    }
}
